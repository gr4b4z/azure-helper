...
namespace ConsoleApp1
{
    public class AzureStorage
    {
        ...
        public AzureStorage(string storageConenctionString)
        {
        ...
        {
            string cloudfilename = file.Replace(path, "").Replace('\\', '/').TrimStart('/');
            ...
            blob.Properties.ContentType = GetMimeType(new FileInfo(file).Extension);
